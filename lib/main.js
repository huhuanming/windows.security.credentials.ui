...
if (fs.existsSync(path.join(__dirname, 'NodeRT_Windows_Security_Credentials_UI.d.js)'))) {
  module.exports = require('./NodeRT_Windows_Security_Credentials_UI.d.js');
} else {
  module.exports = require('../build/Release/binding.node');
}

var externalReferencedNamespaces = ['Windows.Storage.Streams'];
